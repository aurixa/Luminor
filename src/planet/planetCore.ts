 ...
 */
export function getHeightAt(direction: THREE.Vector3, noise: SimplexNoise, craters: Crater[]): number {
 ...
 */
export function getSlopeAt(direction: THREE.Vector3, noise: SimplexNoise, craters: Crater[]): number {
 ...
 */
export function getElevationAtDirection(direction: THREE.Vector3, noise: SimplexNoise, craters: Crater[]): number {
 ...
 */
export function calculateSlopeAtDirection(dir: THREE.Vector3, noise: SimplexNoise, craters: Crater[]): number {
    const p1 = dir.clone();
    const step = 0.01;
